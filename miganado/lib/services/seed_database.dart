...
class SeedDatabase {
  ...
  static Future<void> seedAll(MiGanadoDatabase database) async {
    ...
    final animal4 = AnimalEntity(
      ...
      desparasitado: false,
      tieneVitaminas: true,
      fechaVitaminas: DateTime.now().subtract(const Duration(days: 40)),
      estadoReproductivo: EstadoReproductivo.no_definido,
    );
    ...
    final animal7 = AnimalEntity(
      ...
      precioVenta: 3500000,
      vacunado: true,
      fechaUltimaVacuna: DateTime.now().subtract(const Duration(days: 200)),
      ...
      tieneVitaminas: true,
      fechaVitaminas: DateTime.now().subtract(const Duration(days: 35)),
      estadoReproductivo: EstadoReproductivo.no_definido,
    );
